...
@property (nonatomic, strong) PFFileObject *smallThumbnailImage;
@property (nonatomic, strong) NSArray *tags;

+ (void) postUserVideo: ( PFFileObject * _Nullable )videoFile withCaption: ( NSString * _Nullable )caption withSong:(Song * _Nullable )song withHeight:(NSNumber *)height withWidth:(NSNumber *)width withLowQualityThumbnail:( PFFileObject * _Nullable )lowQualityThumbnailImage withThumbnail:( PFFileObject * _Nullable )thumbnailImage withTags:(NSArray *)tags withCompletion: (PFBooleanResultBlock  _Nullable)completion;
